package org.apache.maven.archetypes.securityConfig;
...
public class SecurityWebApplicationInitializer extends WebSecurityConfigurerAdapter{
	...
	public void configure(HttpSecurity http) throws Exception{
		http.authorizeRequests().antMatchers("/admin.html").access("hasRole('ROLE_ADMIN')")
		.antMatchers("/user.html").access("hasRole('ROLE_USER')").and().formLogin();
